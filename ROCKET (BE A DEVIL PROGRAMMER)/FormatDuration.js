...
function formatDuration(seconds) {
  ...
  for (var i = 0; i < seconds; i++) {
    ...
    if (i === seconds - 1) {
      if (detik === 0) {
        ...
        detik = ' dan ' + String(detik) + ' detik'
      }

      if (menit === 0) {
        menit = ''
      } else {
        if (jam === 0 && hari === 0 && detik === 0) {
          menit = 'dan ' + String(menit) 
        } else {
          menit = String(menit) + ' menit'
        }
      }
  ...
  return tahun + hari + jam + menit + detik
}
